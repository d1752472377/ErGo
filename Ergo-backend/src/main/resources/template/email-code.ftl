    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); ">ErGo</font>
            </th>
        </tr>
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <p>Hello! Thanks for using ErGo your account is being authenticated by email, the
                        verification code is:<font color="#ff8c00">${code}</font>, valid for 5 minutes. Please fill in the verification code as soon as
                        possible!</p>
